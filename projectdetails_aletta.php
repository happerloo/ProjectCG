...
<div class="content">
    ...
    <img class="img-fluid project_img" src="img/aletta_omslag.png" alt="Een sfeerimpressie van de nieuwe Aletta Jacobshal">
      ...
      <div class="row">
        <div class="col">
          <h2>Projectinformatie</h2>
            ...
            <h2>Overlastbeperking tijdens tentamens</h2>
                <p>
        ...
        <div class="col">
          <h2>Foto's van de bouw</h2>
                <img src="img/aletta_binnen.jpg" alt="Sfeerimpressie Aletta Jacobshal" class="img-fluid img-thumbnail">
                <img src="img/aletta_collegezaal.jpg" alt="Sfeerimpressie Aletta Jacobshal" class="img-fluid img-thumbnail">
                <img src="img/aletta_overzicht.jpg" alt="Sfeerimpressie Aletta Jacobshal" class="img-fluid img-thumbnail">
       </div>
      </div>
</div>
</div>
