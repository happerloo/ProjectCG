...
<div class="content">
    ...
    <img class="img-fluid" src="img/zernikelaan_omslag.jpg" alt="Een sfeerimpressie van de zuidgevel van de van Olst Toren">
      ...
      <div class="row">
        <div class="col">
          <h2>Projectinformatie</h2>
            ...
            <h2>Doortrekken Zernike Promenade</h2>
                <p>
            ...
            <p>
                ...
                <h2>Verkeershinder</h2>
                <p>
                    De fietspaden langs de Zernikelaan worden beurtelings aangepakt. Er wordt 3 juni gestart met de Westzijde (langs de vijver van de Aletta Jacobshal). Tot en met eind juni 2019 wordt ter voorbereiding alvast het fietspad langs de Aletta Jacobshal vernieuwd. Ook worden kabels en leidingen verlegd. De Aletta Jacobshal blijft bereikbaar. Dit voorwerk is nodig, zodat het project aan het einde van de zomer – wanneer de campus weer druk bezocht wordt - niet onnodig uitloopt.
                </p>
        ...
        <div class="col">
          <h2>Foto's van de bouw</h2>
                <img src="img/zernikelaan_bomen.jpg" alt="Sfeerimpressie zernikelaan" class="img-fluid img-thumbnail">
                <img src="img/zernikelaan_overzicht.jpg" alt="Sfeerimpressie zernikelaan" class="img-fluid img-thumbnail">
                <img src="img/zernikelaan_promenade.jpg" alt="Sfeerimpressie promenade" class="img-fluid img-thumbnail">
       </div>
      </div>
</div>
</div>
